...
AUTH_CHANNEL = environ.get('AUTH_CHANNEL','-1001723597423')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Aadhi:@Aadhi123@cluster0.yg7q3bu.mongodb.net/?retryWrites=true&w=majority")
